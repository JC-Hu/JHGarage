...
@interface UIViewController (JHGPageViewController)
...
@implementation UIViewController (JHGPageViewController)
...
@interface JHGPageViewController ()<UIScrollViewDelegate>
...
@implementation JHGPageViewController
...
- (instancetype)initWithOrientation:(JHGPageViewControllerNavigationOrientation)orientation
                         ...
                         dataSource:(id<JHGPageViewControllerDataSource>)dataSource {
...
- (void)setDataSource:(id<JHGPageViewControllerDataSource>)dataSource {
...
- (void)__updateDataSourceCount {
    ...
    if (self.numberOfViewControllers!=oldNumberOfViewControllers) {
        ...
        if (self.orientation==JHGPageViewControllerNavigationOrientationHorizontal) {
...
- (CGFloat)realOffsetValueForOffset:(CGPoint)offset {
    return (self.orientation==JHGPageViewControllerNavigationOrientationHorizontal)?offset.x:offset.y;
}

- (CGFloat)realContentWidth {
    return  (self.orientation==JHGPageViewControllerNavigationOrientationHorizontal)?CGRectGetWidth(self.scrollView.frame):CGRectGetHeight(self.scrollView.frame);
}
